...
/**
 * check97 - will check for correct number of arguments
...
/**
 * check99 - will check if file_to was created and/or can be written to
 * @check: checks if true or false
 * @file: file_to name
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descriptor of file_to, or -1
...
/**
 * check100 - will check if file descriptors were closed properly
 * @check: checks if true or false
 * @fd: file descriptor
 *
 * Return: void
...
/**
 * main - will copy contenst of a file to another file.
